export default function Tuesday() {
    return (
      ...
      <main className="flex items-center flex-col font-bold text-[#320250] bg-[#8c52ff]">
        <h1 className="text-2xl mb-3">TUESDAY</h1>
        <table className="table-fixed w-[80%] md:w-[600px] border border-[rgb(72,22,102)]">
          ...
          <tbody>
            <tr>
              <td className="p-3 border-[#481666] border">Sosiologi</td>
              <td className="p-3 border-[#481666] border">07.00-09.15</td>
            </tr>
            <tr>
              <td className="p-3 border-[#481666] border">Matematika</td>
              <td className="p-3 border-[#481666] border">09.15-11.25</td>
            </tr>
            <tr>
              <td className="p-3 border-[#481666] border">Sejarah</td>
              <td className="p-3 border-[#481666] border">11.25-14.20</td>
            </tr>
            <tr>
              <td className="p-3 border-[#481666] border">PPKN</td>
